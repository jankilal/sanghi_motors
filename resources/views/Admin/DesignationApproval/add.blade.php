                                ...
                                <div class="row">
                                    <div class="col-md-6 ">
                                        <div class="form-group {{ $errors->has('designation_name') ? 'has-error' : '' }}">
                                            ...
                                            {{Form::text('designation_name',old('designation_name', ''),['class' => 'form-control required','placeholder'=>'Designation Name'])}}
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group {{ $errors->has('designation_code') ? 'has-error' : '' }}">
                                        ...
                                        {{Form::text('designation_code',old('designation_code', ''),['class' => 'form-control','placeholder'=>'Designation Code...'])}}
