                    ...
                    <div class="hpanel">
                        <div class="panel-body">
                            <form role="form" enctype="multipart/form-data" id="model-form" method="post" action="{{ route('model.store') }}" novalidate="novalidate">
                                {{ csrf_field() }}
                                {{ Form::hidden('id', isset($model) ? $model->id : '') }}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('model_name') ? 'has-error' : '' }}">
                                            <label>Model Name<span class="text-danger">*</span></label>
                                            {{Form::text('model_name',old('model_name', isset($model) ? $model->model_name : ''),['class' => 'form-control required','placeholder'=>'Model Name'])}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('model_number') ? 'has-error' : '' }}">
                                            ...
                                            {{Form::text('model_number',old('model_number', isset($model) ? $model->model_number : ''),['class' => 'form-control required','placeholder'=>'Model Number'])}}
                                ...
                                <div class="row">
                                    <div class="col-md-6 ">
                                        <div class="form-group {{ $errors->has('model_color') ? 'has-error' : '' }}">
                                            ...
                                            {{Form::text('model_color',old('model_color', isset($model) ? $model->model_color : ''),['class' => 'form-control required','placeholder'=>'Model Color'])}}
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group {{ $errors->has('weight') ? 'has-error' : '' }}">
                                            ...
                                            {{Form::text('weight',old('weight', isset($model) ? $model->weight : ''),['class' => 'form-control required','placeholder'=>'Weight'])}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('lob_id') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control" name="lob_id" id="lob_id">
                                            @foreach($lob_list as $s_res)
                                                <option @if($model->lob_id == $s_res->id ) selected  @endif value="{{ $s_res->id }}" >{{ $s_res->name }}</option>
                                            @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{Form::textarea('description',old('description', isset($model) ? $model->description : ''),['class' => 'form-control required','placeholder'=>'Description'])}}
                                        </div>
                                    </div>
                                </div>
                                <div><br>
